...
export default function About() {
  return (
    <section id="about" className="relative py-24 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a]">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <motion.p
            ...
            transition={{ duration: 0.6, ease: "easeOut" }}
          >
            Specializing in AI-assisted development workflows, I build scalable full-stack systems
            that power modern web and mobile applications with intelligent capabilities.
          </motion.p>
        </motion.div>
